...
public class UserService {
    ...
    // [AÑADIDO] Propiedad configurable para el email del super admin.
    // Impacto: Elimina el valor hardcodeado, permitiendo cambiar el admin sin recompilar el código.
    @Value("${super.admin.email:superadmin@test.com}")
    ...
    void sendRegistrationMailToSuperAdmins(OwnUser user, UserSignupRequest userSignupRequest) {
        // [MODIFICADO] Uso de la variable superAdminEmail en lugar de string literal.
        // Impacto: Mejora la mantenibilidad y seguridad del código.
        if (user.getEmail().equals(superAdminEmail)) return;
