...
public class TaskService {
    ...
    // [AÑADIDO] Servicio para delegar el borrado masivo al repositorio.
    // Impacto: Expone la funcionalidad de borrado optimizado a los controladores.
    public void deleteByWorkOrder(Long id) {
        taskRepository.deleteByWorkOrder_Id(id);
    }

    // [AÑADIDO] Servicio para delegar el borrado masivo al repositorio.
    // Impacto: Expone la funcionalidad de borrado optimizado a los controladores.
    public void deleteByPreventiveMaintenance(Long id) {
        taskRepository.deleteByPreventiveMaintenance_Id(id);
    }
}
