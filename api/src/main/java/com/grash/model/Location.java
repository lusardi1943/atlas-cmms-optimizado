...
public class Location extends CompanyAudit {
    ...
    // Impacto: Evita la carga recursiva de ubicaciones padres, crucial para jerarquías profundas.
    @ManyToOne(fetch = FetchType.LAZY)
    @OnDelete(action = OnDeleteAction.CASCADE)
    private Location parentLocation;

    // [MODIFICADO] Cambiado a FetchType.LAZY.
    // Impacto: Evita cargar la imagen de la ubicación si no es necesaria.
    @ManyToOne(fetch = FetchType.LAZY)
    private File image;
