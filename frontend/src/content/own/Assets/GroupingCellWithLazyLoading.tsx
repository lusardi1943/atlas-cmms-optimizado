  ...
  return (
    <Box className={classes.root} sx={{ ml: rowNode.depth * 2 }}>
      <div className={classes.toggle}>
        {(row?.hasChildren || rowNode.isAutoGenerated) && (
          <IconButton
            size="small"
            onClick={handleClick}
      ...
      {/* [MODIFICADO] Si es una fila autogenerada (virtual), mostrar el nombre aquí porque la columna Nombre estará vacía */}
      {rowNode.isAutoGenerated && (
        <Box sx={{ ml: 1, fontWeight: 'bold' }}>{props.value}</Box>
      )}
    </Box>
  );
}
